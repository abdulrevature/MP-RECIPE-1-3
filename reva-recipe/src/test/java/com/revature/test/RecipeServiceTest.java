...
public class RecipeServiceTest {
    ...
    void setUpMocks() {
        ...
        MOCKS= Arrays.asList(
            new Recipe(1, "Pasta", "Boil water, add pasta, add sauce"),
            new Recipe(2, "Pizza", "Make dough, add sauce, add cheese, bake"),
            new Recipe(3, "Salad", "Chop lettuce, add dressing"),
            new Recipe(4, "Sandwich", "Put stuff between bread"),
            new Recipe(5, "Soup", "Boil water, add stuff")
        );
    }
    ...
    @Test
    void updateRecipe() {
        Recipe existingRecipe = new Recipe(42, "Existing Recipe", "Existing Recipe Instructions");
        ArgumentCaptor<Recipe> recipeCaptor = ArgumentCaptor.forClass(Recipe.class);
